...
def getPath(obj, method):
    ...
    ###    http verb, then for each method argument, a path
    ###    parameter in format /param_name/{param_name:.*}/
    ...
    for obj in objects:
        ...
        for method in methods:
            ...
            if verb != None:
                ...
                print("<{}> registered path <{}>".format(obj.__class__.__name__, path))
